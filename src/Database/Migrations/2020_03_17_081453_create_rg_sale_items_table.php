...
class CreateRgSaleItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_sale_items', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_sale_items');
    }
}
