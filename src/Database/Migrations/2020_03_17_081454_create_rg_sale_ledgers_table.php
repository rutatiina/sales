...
class CreateRgSaleLedgersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_sale_ledgers', function (Blueprint $table) {
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_sale_ledgers');
    }
}
