...
class CreateRgSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_sales', function (Blueprint $table) {
            ...
            $table->string('document_name', 50)->default('Sales Receipt');
    ...
    {
        Schema::connection('tenant')->dropIfExists('rg_sales');
    }
}
